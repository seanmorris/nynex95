...
var GitHub = /*#__PURE__*/function (_Task) {
  ...
  _createClass(GitHub, [{
    ...
    value: function execute() {
      ...
      window.open('https://github.com/login/oauth/authorize' + '?redirect_uri=https://github-auth.unholyshit.workers.dev/' + '&client_id=7150d20fb5a11fe1d332' + '&scope=public_repo' + '&state=' + state, "github-login-".concat(this.tid), "left=100,top=100,width=750,height=500,resizable=0,scrollbars=0,location=0,menubar=0,toolbar=0,status=0");
